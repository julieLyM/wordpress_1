...
<!-- the_title permet d'afficher le titre de la PAGE,ARTICLE que le client à choisi ( CLIQUER ) / the_permalink permet de creer un lien permanant suivant le clque du client  -->
